...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="services" options={{ title: 'Services', tabBarIcon: ({ color }) => <Feather name="grid" size={22} color={color} /> }} />
      <Tabs.Screen name="transactions" options={{ title: 'Activity', tabBarIcon: ({ color }) => <Feather name="activity" size={22} color={color} /> }} />
